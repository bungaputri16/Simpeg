...
@section('content')
    <div class="container">
        <div class="flex justify-between">
            <p class="pb-2 font-bold">Perizinan {{ $unitkerja->name }}</p>
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    @foreach ($perizinan as $izin)
                                        <tr>
                                            ...
                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200 font-bold">
                                                ...
                                                <div class="flex justify-end">
                                                    <div class="hs-dropdown relative inline-flex">
                                                        ...
                                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 w-56 hidden z-10 mt-2 min-w-[15rem] bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700 dark:divide-gray-700"
                                                            ...
                                                            <div>
                                                                <a
                                                                    href="{{ route('request-perizinan-atasan-langsung.formditangguhkan', ['id' => $izin->id]) }}">
                                                                    <button type="button"
                                                            ...
                                                            <div>
                                                                <a
                                                                href="{{ route('request-perizinan-atasan-langsung.formperubahan', ['id' => $izin->id]) }}">
                                                                <button type="button"
                                                                    class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border-2 border-yellow-200 font-semibold text-yellow-500 hover:text-white hover:bg-yellow-500 hover:border-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-200 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800">
                                                                    Perubahan
                                                                </button>
                                                            ...
                                                            <div>
                                                                <a
                                                                href="{{ route('request-perizinan-atasan-langsung.formtidakdisetujui', ['id' => $izin->id]) }}">
                                                                <button type="button"
                                                                    class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border-2 border-yellow-200 font-semibold text-yellow-500 hover:text-white hover:bg-yellow-500 hover:border-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-200 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800">
                                                                    Tidak Disetujui
                                                                </button>
                                                            ...
                                                            {{-- <form
                                                                action="{{ route('request-perizinan-atasan-langsung.perubahan', ['id' => $izin->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                <button type="submit"
                                                            ...
                                                            <form
                                                                action="{{ route('request-perizinan-atasan-langsung.izinkan', ['id' => $izin->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                <button type="submit"
                                                            ...
                                                            {{-- <form
                                                                action="{{ route('request-perizinan-atasan-langsung.tolak', ['id' => $izin->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                <button type="submit"
