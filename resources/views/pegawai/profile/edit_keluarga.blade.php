    ...
    <div class="container">
        <div class="max-w-2xl px-4  sm:px-6 lg:px-8  mx-auto">
            ...
            <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                ...
                <form method="POST" action="{{ route('update-keluarga') }}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    ...
                    <div
                        ...
                        <div class="mt-2 space-y-3">
                            {{-- <input name="status_perkawinan" type="text"
                            ...
                            <div>
                                ...
                                <select name="status_perkawinan" value="{{ $keluarga->status_perkawinan }}"
                                    ...
                                    <option disabled>Status Perkawinan</option>
                            ...
                            <div>
                                ...
                                <input name="nama_pasangan" type="text" value= "{{ $keluarga->nama_pasangan }}"
                                    class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                            ...
                            <div>
                                ...
                                <input name="pekerjaan_pasangan" type="text" value= "{{ $keluarga->pekerjaan_pasangan }}"
                                    class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                                    placeholder="Perkerjaan Suami/Istri">
                            </div>
                            <label class="inline-block text-sm font-medium dark:text-white">
                                File Pendukung
                            </label>
