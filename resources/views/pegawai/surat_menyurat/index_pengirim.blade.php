...
@section('content')
    <div class="container">
        ...
        <div class="flex justify-between">
            <p class="font-bold">Surat Menyurat</p>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th></th>
                                        <th scope="col"
                                            class="px-6 py-3 w-[200px]  text-right text-xs font-medium text-gray-500 uppercase">Action
                                        </th>
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    @foreach ($surat as $item)
                                        <tr>
                                            <td
                                                class="w-[100px] px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                            ...
                                            <td
                                                class="w-[40px] px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                                21 okt
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium ">
                                                <div class="flex justify-end">
                                                    <form action="{{ route('surat.delete', ['id' => $item->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
