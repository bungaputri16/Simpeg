                                                ...
                                                <div class="flex justify-end">
                                                    <div class="hs-dropdown relative inline-flex">
                                                        ...
                                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 w-56 hidden z-10 mt-2 min-w-[15rem] bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700 dark:divide-gray-700" aria-labelledby="hs-dropdown-basic">
                                                            {{-- <form action="{{ route('pegawai.updateRolePegawaiAdmin', ['id' => $pg->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                          ...
                                                          <form action="{{ route('pegawai.updateRolePegawaiPegawai', ['id' => $pg->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <button class="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300" href="#">
                                                    ...
                                                    <a href="{{ route('admin-pegawai.edit', ['id' => $pg->id]) }}">
                                                        <button type="button"
