                  ...
                  <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-4 sm:p-7">
                      <div class="text-center">
                        <h2 class="block text-2xl font-bold text-gray-800 dark:text-gray-200">Surat Keputusan</h2>
                      </div>
                        ...
                        <form method="POST" action="{{ route('management-surat-keputusan.store') }}" enctype="multipart/form-data">
                          ...
                          <div class="grid gap-y-4">
                            ...
                            <div>
                              ...
                              <select name="penerima_id" id="provinsiSelect" class=" py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400"
                                  style="width: 100%;">
                            ...
                            <div>
                              <label for="nomor_sk" class="block text-sm mb-2 dark:text-white">Nomor SK</label>
                              <div class="relative">
                                <input type="text" id="nomor_sk" name="nomor_sk" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400" required >
                          ...
                          <div class=" space-y-3">
                            ...
                            <button type="submit" class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800">Kirim</button>
                          </div>
                        </form>
                        <!-- End Form -->
                      </div>
