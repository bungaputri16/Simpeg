    ...
    <div class="container">
        <div class="max-w-2xl px-4  sm:px-6 lg:px-8  mx-auto">
            ...
            <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                ...
                <form method="POST" action="{{ route('jabatan-struktural.store') }}">
                    @csrf
                    ...
                    <div
                        ...
                        <label class="inline-block text-sm font-medium dark:text-white">
                            Apakah Jabatan yg memiliki wewenang?
                        </label>
                        <select required name="is_wewenang" class="py-2 px-3 pr-9 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400">
